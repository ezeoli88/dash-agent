 ...
 */
export const AgentTypeSchema = z.enum(['claude-code', 'codex', 'gemini', 'copilot', 'openrouter', 'minimax']);
export type AgentType = z.infer<typeof AgentTypeSchema>;

/**
 * Agent types list for UI iteration
 */
export const AGENT_TYPES = ['claude-code', 'codex', 'gemini', 'copilot', 'openrouter', 'minimax'] as const;
